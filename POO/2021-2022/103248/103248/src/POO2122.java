...
public class POO2122 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		PrintStream fl = new PrintStream(new File("POO_2021_Ep.txt"));
	...
	private static void alinea1(PrintStream out) {
		...
		PacoteTuristico p1 = at1.pacoteTuristico("Sossego", 5, 390);
		...
		PacoteTuristico p2 = at1.pacoteTuristico("Descanso", 7, 650);
		...
		PacoteTuristico p3 = at1.pacoteTuristico("Sempre a mexer", 8, 460);
		...
		p3.adicionaServico(new Transporte(2, 2000, Combustivel.HIBRIDO));
	...
	private static void alinea2(PrintStream out) {
		...
		if (at2 != null) {
			...
			for (PacoteTuristico p: at2.pacotesPorPreco(450))	// devolve todos os pacotes turísticos da agencia com preço pessoa/noite inferior ao indicado, 
				out.println(p);										// ordenados do preço mais alto ao mais baixo
